...
QMD exposes six MCP tools:

<CardGroup cols={2}>
  <Card title="query" icon="magnifying-glass" href="/mcp/qmd-search">
    Multi-strategy search with lex/vec/hyde sub-queries
  </Card>
  <Card title="get" icon="file" href="/mcp/qmd-get">
    Retrieve a single document by path or docid
  </Card>
  <Card title="multi_get" icon="files" href="/mcp/qmd-multi-get">
    Retrieve multiple documents by glob pattern
  </Card>
  <Card title="status" icon="chart-simple" href="/mcp/qmd-status">
